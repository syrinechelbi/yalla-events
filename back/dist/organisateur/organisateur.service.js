...
let OrganisateurService = class OrganisateurService {
    constructor(organisateursRepository) {
        this.organisateursRepository = organisateursRepository;
    }
    async findAll() {
    ...
    async create(createOrganisateurDto) {
    ...
    async update(id, updateOrganisateurDto) {
        ...
        if (!existingOrganisateur) {
            throw new common_1.BadRequestException('Organisateur not found');
        }
